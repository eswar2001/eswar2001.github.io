...
export const Project = (props) => {
    ...
    if (props.data.homepage)
        return (<div className='project'>
            <h3><a href={props.data.homepage} title={props.data.name}>{props.data.name}</a></h3>
            ...
            <a href={props.data.html_url}
                title={props.data.name} className='ico-visit' target='_blank' rel='noopener'>Gtihub</a>
            <a href={props.data.homepage}
                title={props.data.name} className='ico-visit' target='_blank' rel='noopener'>Visit</a>
        </div>)
    else {
        return (<div className='project'>
            <h3><a href={props.data.homepage} title={props.data.name}>{props.data.name}</a></h3>
